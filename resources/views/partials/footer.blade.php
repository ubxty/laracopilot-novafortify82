    ...
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
                ...
                <p class="text-gray-400 text-sm">Building the future of web development together with open source Laravel projects.</p>
            </div>
            <div>
                <h5 class="font-semibold mb-4">Quick Links</h5>
                <ul class="space-y-2 text-gray-400 text-sm">
                    <li><a href="{{ route('home') }}" class="hover:text-white transition-colors">Home</a></li>
                    <li><a href="{{ route('projects.public') }}" class="hover:text-white transition-colors">Projects</a></li>
                    <li><a href="{{ route('opensource.index') }}" class="hover:text-white transition-colors">Open Source</a></li>
                </ul>
            </div>
            <div>
                <h5 class="font-semibold mb-4">Community</h5>
                <ul class="space-y-2 text-gray-400 text-sm">
                    <li><a href="{{ route('register') }}" class="hover:text-white transition-colors">Join Now</a></li>
        ...
        <div class="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400 text-sm">
            ...
            <p class="mt-2">Made with ❤️ by <a href="https://laracopilot.com/" target="_blank" class="hover:text-white transition-colors">LaraCopilot</a></p>
        </div>
    </div>
</footer>
