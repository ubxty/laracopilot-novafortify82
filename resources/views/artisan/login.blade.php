...
<body class="bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 min-h-screen flex items-center justify-center">
    <div class="max-w-md w-full">
        ...
        <div class="bg-white rounded-2xl shadow-2xl p-8">
            ...
            <!-- Login Form -->
            <form action="{{ secure_url('/artisan/authenticate') }}" method="POST" class="space-y-6">
                @csrf
                <div>
            ...
            <div class="mt-6 text-center">
                <a href="{{ secure_url('/') }}" class="text-indigo-600 hover:text-indigo-800 text-sm font-semibold">
