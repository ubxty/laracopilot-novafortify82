        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center space-x-8">
                    <a href="{{ secure_url('/') }}" class="text-2xl font-bold">Laravel Portal</a>
                    <div class="hidden md:flex space-x-4">
                        <a href="{{ secure_url('/artisan') }}" class="bg-indigo-700 px-3 py-2 rounded">Artisan Terminal</a>
                    </div>
                </div>
                <div class="flex items-center space-x-4">
                    ...
                    <form action="{{ secure_url('/artisan/logout') }}" method="POST">
                        @csrf
    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex space-x-3">
                <a href="{{ secure_url('/artisan/refresh') }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded transition">
                    <i class="fas fa-sync-alt mr-2"></i>Refresh Logs
                </a>
                <form action="{{ secure_url('/artisan/clear-logs') }}" method="POST" class="inline">
                    @csrf
        ...
        <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
            ...
            <form action="{{ secure_url('/artisan/run') }}" method="POST" class="space-y-4">
                @csrf
                <div>
